...
int CWalletTx::GetBlocksToMaturity() const
{
    ...
    //YEARTODO Some wallets are still not abandoning coinstakes correctly
...
void CWallet::StakeYEARs(bool fStake, CConnman* connman, CTxMemPool* mempool)
{
    ::StakeYEARs(fStake, this, connman, mempool, stakeThread);
}

void CWallet::StartStake(CConnman *connman, CTxMemPool* mempool)
{
    m_enabled_staking = true;
    StakeYEARs(true, connman, mempool);
}
