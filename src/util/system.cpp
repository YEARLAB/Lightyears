...
const char * const BITCOIN_CONF_FILENAME = "lightyears.conf";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Lightyears
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Lightyears
    // Mac: ~/Library/Application Support/Lightyears
    // Unix: ~/.lightyears
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Lightyears";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Lightyears";
#else
    // Unix
    return pathRet / ".lightyears";
#endif
#endif
}
