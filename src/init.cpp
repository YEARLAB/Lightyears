 ...
 */
static const char* BITCOIN_PID_FILENAME = "lightyearsd.pid";
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/YEARLAB/lightyears>";

    return (strprintf(_("Copyright (C) %i The Lightyears Core Developers").translated, COPYRIGHT_YEAR) + " ") +
           "\n" +
