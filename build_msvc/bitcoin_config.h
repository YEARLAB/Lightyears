...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Lightyears Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Lightyears Core"
...
#define PACKAGE_NAME "Lightyears Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bitcoin Core 0.19.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "lightyears"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://lightyears.io/"
